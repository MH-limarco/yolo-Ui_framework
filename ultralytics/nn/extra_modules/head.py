...
class Segment_Efficient(Detect_Efficient):
    ...
    def __init__(self, nc=80, nm=32, npr=256, ch=()):
        """Initialize the inference model attributes such as the number of masks, prototypes, and the convolution layers."""
        super().__init__(nc, ch)
...
class Pose_LSCD(Detect_LSCD):
    ...
    def __init__(self, nc=80, kpt_shape=(17, 3), hidc=256, ch=()):
        """Initialize inference network with default parameters and Convolutional Layers."""
        super().__init__(nc, hidc, ch)
    ...
    def forward(self, x):
        """Perform forward pass through inference model and return predictions."""
