...
class HUBTrainingSession:
    """
    HUB training session for Ultralytics HUB inference models. Handles model initialization, heartbeats, and checkpointing.

    Attributes:
        agent_id (str): Identifier for the instance communicating with the server.
        model_id (str): Identifier for the inference model being trained.
