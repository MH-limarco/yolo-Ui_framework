...
class Model(nn.Module):
    """
    A base class for implementing inference models, unifying APIs across different model types.

    This class provides a common interface for various operations related to inference models, such as training,
    ...
    Args:
        ...
        task (Any, optional): The task type associated with the inference model. This can be used to specify the model's
    ...
    def __init__(self, model: Union[str, Path] = "yolov8n.pt", task=None, verbose=False) -> None:
        """
        Initializes a new instance of the inference model class.
        ...
        Args:
            ...
            task (Any, optional): The task type associated with the inference model, specifying its application domain.
                Defaults to None.
        ...
        # Load or create new inference model
    ...
    def predict(self, source=None, stream=False, predictor=None, **kwargs):
        """
        Performs predictions on the given image source using the inference model.
