...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        self.pretty_name = Path(self.model.yaml.get("yaml_file", self.file)).stem.replace("yolo", "inference")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an Ultralytics inference model for Apple iOS CoreML export."""

    def __init__(self, model, im):
        """Initialize the IOSDetectModel class with a inference model and example image."""
        super().__init__()
