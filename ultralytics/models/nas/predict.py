...
class NASPredictor(BasePredictor):
    """
    Ultralytics inference NAS Predictor for object detection.

    This class extends the `BasePredictor` from Ultralytics engine and is responsible for post-processing the
    raw predictions generated by the inference NAS models. It applies operations like non-maximum suppression and
