...
HELP_MSG = """
    ...
    2. Use the Python SDK:
        ...
        # Load a model
        model = inference('yolov8n.yaml')  # build a new model from scratch
        model = inference("yolov8n.pt")  # load a pretrained model (recommended for training)
...
def set_sentry():
    ...
    Conditions required to send errors (ALL conditions must be met or no errors will be reported):
        ...
        - sync=True in inference settings
