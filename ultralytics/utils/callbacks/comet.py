...
def _fetch_trainer_metadata(trainer):
    """Returns metadata for inference training including epoch and asset saving status."""
...
def _format_prediction_annotations_for_detection(image_path, metadata, class_label_map=None):
    """Format inference predictions for object detection visualization."""
...
def on_pretrain_routine_start(trainer):
    """Creates or resumes a CometML experiment at the start of a inference pre-training routine."""
